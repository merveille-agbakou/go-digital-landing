    ...
    <div class="page-banner-area">
        <div class="container">
            <div class="page-banner-content">
                <h2>Demande de devis pour un projet</h2>
                <ul>
                    <li>
                        <a href="{{ route('index') }}">Contact</a>
                    </li>
                    <li>Demande de devis projet</li>
                </ul>
            </div>
        </div>
    ...
    <div class="contact-area ptb-100">
        <div class="container">
            <div class="contact-form">
                ...
                <form id="contactForm" action="{{route('post.contact',['contactType' => 'projet'])}}" method="post"
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                <input type="text" name="entreprise" id="entreprise" class="form-control" required
                                    data-error="Entrer le nom de votre entreprise"
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                <select class="form-control" name="category">
                                    ...
                                    <option value="3">Stratégie Com </option>
                                    <option value="4">Développement</option>
                                    <option value="5">E commerce </option>
                                    <option value="6">SEO / SEA </option>
                                    <option value="7">Application Mobile </option>
                                    <option value="8">Community Management </option>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                                <textarea name="message" class="form-control" id="message" cols="30" rows="5" required
                                    data-error="Décrivez en 100 mots votre projet"
                                    placeholder="Décrivez en 100 mots votre projet"></textarea>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                                <div class="contact-address">
                                    <label for="file-input" class="form-control-label">
                                        <h4>Ajouter une fiche projet si vous en disposez</h4>
                                    </label>
                                    <br /> <br />
